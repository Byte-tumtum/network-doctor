# Graph Report - network-doctor  (2026-07-21)

## Corpus Check
- 85 files · ~88,068 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 717 nodes · 1364 edges · 102 communities (62 shown, 40 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 212 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a3b4eda5`
...
Cohesion: 0.07
Nodes (23): CancelFunc, appendJobLine(), CancelFunc, Cmd, Context, Duration, IP, KeyMsg (+15 more)

### Community 2 - "Probe Configuration Build"
Cohesion: 0.11
Nodes (32): CertPool, Config, Attempt, netops, Probe, ProbeID, ProbeResult, Status (+24 more)
...
Cohesion: 0.09
Nodes (32): fakeConn, iwreq, scriptConn, Addr, Conn, Context, Reader, T (+24 more)
...
Cohesion: 0.15
Nodes (25): classifyJob(), Cmd, Context, Duration, Msg, Reader, readCappedLine(), startTool() (+17 more)
...
### Community 100 - "CancelFunc"
Cohesion: 0.25
Nodes (7): Claude's response, Claude's response, Claude's response, Plan Review Log: Make job switching visibly confirm the switch happened, Round 1 — Codex, Round 2 — Codex, Round 3 — Codex

### Community 101 - "Cmd"
Cohesion: 0.29
Nodes (6): Approach, Goal, Key decisions & tradeoffs, Out of scope, Plan: Make job switching visibly confirm the switch happened, Risks / open questions

## Knowledge Gaps
- **175 isolated node(s):** `github.com/heymaikol/network-doctor`, `iwreq`, `ToolOutputMsg`, `scheduleMsg`, `Claude's response` (+170 more)
...
- `Diagnose()` (5× useful, score=4.558370994)
- `.outputView()` (5× useful, score=4.380840712) _(code changed — re-verify)_
- `README.md` (5× useful, score=4.061178389)
- `.Update()` (4× useful, score=3.528703574) _(code changed — re-verify)_
- `.handleViewKey()` (4× useful, score=3.468334304) _(code changed — re-verify)_
- `DowngradeEgress()` (3× useful, score=2.8245142)
- `report` (3× useful, score=2.691952771)
- `Install` (3× useful, score=2.183123542)
- `.View()` (2× useful, score=1.874760323) _(code changed — re-verify)_
- `JSON output` (2× useful, score=1.85740611)
...
- **Why does `model` connect `UI Model State` to `Probe Configuration Build`, `UI Application Toolbox`, `Job Execution Lifecycle`, `Probe Construction Tests`, `model`?**
  _High betweenness centrality (0.098) - this node is a cross-community bridge._
- **Why does `New()` connect `Probe Construction Tests` to `Model Extra Tests`, `UI Model State`, `ExitCode`, `Network Connection Test Doubles`, `UI Application Toolbox`, `model`, `Target`, `ExitCode`?**
  _High betweenness centrality (0.087) - this node is a cross-community bridge._
- **Why does `newModel()` connect `Model Extra Tests` to `ExitCode`, `UI Application Toolbox`, `Probe Construction Tests`, `model`, `ExitCode`?**
