# Graph Report - network-doctor  (2026-06-28)

## Corpus Check
- 34 files · ~18,531 words
...
- **Why does `BuildProbes()` connect `TUI Model (Bubble Tea)` to `Community 17`, `Network Checks Engine`?**
