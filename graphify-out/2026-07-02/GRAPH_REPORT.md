# Graph Report - network-doctor  (2026-07-02)

## Corpus Check
- 48 files · ~20,963 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 380 nodes · 733 edges · 27 communities (26 shown, 1 thin omitted)
- Extraction: 82% EXTRACTED · 18% INFERRED · 0% AMBIGUOUS · INFERRED: 135 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8527614b`
...
- `main()` --calls--> `ExitCode()`  [INFERRED]
  main.go → internal/ui/app.go
- `TestJobStatusString()` --calls--> `JobStatus`  [INFERRED]
...
Cohesion: 0.12
Nodes (41): Model, T, KeyMsg, Model, T, T, Target, asModelP() (+33 more)
...
Cohesion: 0.09
Nodes (25): CancelFunc, Cmd, Context, Fact, job, JobStatus, KeyMsg, Msg (+17 more)
...
Cohesion: 0.20
Nodes (9): Claude's response, Claude's response, Claude's response, Claude's response, Plan Review Log: GitHub Releases via GoReleaser, Round 1 — Codex, Round 2 — Codex, Round 3 — Codex (+1 more)
...
Cohesion: 0.12
Nodes (21): mustTarget(), TestBuildProbesNamesProtocolApplicationRow(), TestBuildProbesShape(), TestRemaining(), Proto, Target, ParseTarget(), TestParseTarget() (+13 more)
...
Cohesion: 0.29
Nodes (6): Approach, Goal, Key decisions & tradeoffs, Out of scope, Plan: GitHub Releases via GoReleaser, Risks / open questions
...
## Knowledge Gaps
- **73 isolated node(s):** `scheduleMsg`, `Context`, `CancelFunc`, `job`, `Time` (+68 more)
...
- **What connects `scheduleMsg`, `Context`, `CancelFunc` to the rest of the system?**
