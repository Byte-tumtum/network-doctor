# Graph Report - network-doctor  (2026-07-23)

## Corpus Check
- 84 files · ~85,770 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 708 nodes · 1350 edges · 100 communities (60 shown, 40 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 217 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9de5d602`
...
Cohesion: 0.08
Nodes (20): appendJobLine(), CancelFunc, Cmd, Context, Duration, IP, KeyMsg, Msg (+12 more)
...
Cohesion: 0.12
Nodes (23): FlagSet, ExitCode(), Model, T, TestToolboxExitZero(), TestToolHotkeysUnique(), TestToolsFor(), init() (+15 more)
...
### Community 20 - "model"
Cohesion: 0.10
Nodes (28): Proto, silentConn, Target, T, Time, TestBannerProbeReadTimeout(), TestBannerProbeReadTimeoutHonorsContext(), TestDialIPsCancelledStopsEarly() (+20 more)
...
## Knowledge Gaps
- **170 isolated node(s):** `github.com/heymaikol/network-doctor`, `iwreq`, `ToolOutputMsg`, `scheduleMsg`, `Arch Linux (AUR)` (+165 more)
...
- `Diagnose()` (6× useful, score=5.325693802)
- `.outputView()` (5× useful, score=4.157577042)
- `README.md` (5× useful, score=3.854205881)
- `.Update()` (4× useful, score=3.348867931)
- `.handleViewKey()` (4× useful, score=3.291575299)
- `DowngradeEgress()` (3× useful, score=2.680566622)
- `report` (3× useful, score=2.554761009) _(code changed — re-verify)_
- `Install` (3× useful, score=2.071863579)
- `.View()` (2× useful, score=1.779215678)
- `JSON output` (2× useful, score=1.762745899)
...
- **Why does `New()` connect `model` to `Model Extra Tests`, `UI Model State`, `Probe Configuration Build`, `ExitCode`, `Network Connection Test Doubles`, `UI Application Toolbox`, `Probe Construction Tests`?**
  _High betweenness centrality (0.088) - this node is a cross-community bridge._
- **Why does `model` connect `UI Model State` to `Probe Configuration Build`, `model`, `UI Application Toolbox`?**
  _High betweenness centrality (0.082) - this node is a cross-community bridge._
- **Why does `newModel()` connect `Model Extra Tests` to `ExitCode`, `model`, `UI Application Toolbox`, `Probe Construction Tests`?**
