# Graph Report - network-doctor  (2026-08-01)

## Corpus Check
- 119 files · ~179,542 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1083 nodes · 2009 edges · 132 communities (93 shown, 39 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 324 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f837dc4c`
...
Cohesion: 0.08
Nodes (92): T, TestInit(), T, TestAppendJobLine(), TestClassifyJob(), TestConcurrentToolsCanSwitch(), TestDeferredQuit(), TestDeferredRestart() (+84 more)

### Community 1 - "UI Model State"
Cohesion: 0.07
Nodes (38): Proto, Target, IP, parsePort(), ParseTarget(), T, TestParseTarget(), TestParseTargetCanonicalRaw() (+30 more)

### Community 2 - "Probe Configuration Build"
Cohesion: 0.08
Nodes (56): CertPool, Config, Attempt, netops, Portal, Probe, ProbeID, ProbeResult (+48 more)
...
Cohesion: 0.13
Nodes (15): Commands you will need, Current state, Done criteria, Git workflow, Maintenance notes, Plan 004: Exit nonzero when JSON watch is interrupted before its first report, Scope, Status (+7 more)
...
Cohesion: 0.12
Nodes (27): silentConn, T, Time, TestBannerProbeReadTimeout(), TestBannerProbeReadTimeoutHonorsContext(), TestBannerProbeValidatesProtocol(), TestDialIPsCancelledStopsEarly(), TestDialIPsRacesStaggered() (+19 more)
...
Cohesion: 0.11
Nodes (18): Arch Linux (AUR), Built with, Development, Drill-down tools, Everywhere else, Exit codes, How it diagnoses, Install (+10 more)
...
Cohesion: 0.48
Nodes (6): T, TestDialFromSourceLoopback(), TestDialIPsLoopback(), TestDialIPsRefusedLoopback(), TestPathIdentityLoopback(), TestPMTUProbeLoopbackSilentPeerDoesNotWarn()
...
### Community 87 - "Target"
Cohesion: 0.13
Nodes (29): T, mustTarget(), TestBuildProbesNamesProtocolApplicationRow(), TestBuildProbesShape(), TestSSIDDoesNotGateNetworkProbes(), TestWrapRunTimesAndCleans(), Diagnose(), downgradeEgress() (+21 more)
...
Cohesion: 0.14
Nodes (20): FileMode, Cmd, KeyMsg, model, copyReport(), exportReport(), osc52Sequence(), captureStderr() (+12 more)
...
### Community 106 - "ssh.go"
Cohesion: 0.13
Nodes (15): Commands you will need, Current state, Done criteria, Git workflow, Maintenance notes, Plan 006: Compile in CI with the release cgo setting, Scope, Status (+7 more)
...
### Community 109 - "IP"
Cohesion: 0.09
Nodes (37): Buffer, FlagSet, ExitCode(), Model, T, TestToolboxExitZero(), TestToolsFor(), askpass() (+29 more)
...
Cohesion: 0.23
Nodes (9): advertisedName, avahiTXT(), AdvertisedNames(), Context, parseAvahiNames(), unescapeAvahi(), T, TestParseAvahiNames() (+1 more)

### Community 112 - "Clean"
Cohesion: 0.21
Nodes (5): Context, ReverseName(), Clean(), Cmd, Msg

### Community 113 - "model"
Cohesion: 0.19
Nodes (7): CancelFunc, Context, Duration, Time, jobState, model, noticeDoneMsg

### Community 114 - "model"
Cohesion: 0.27
Nodes (4): filterLines(), jobState, model, matchesFilter()

### Community 115 - "parseSSHAliases"
Cohesion: 0.33
Nodes (5): Reader, parseSSHAliases(), SSHHostAliases(), T, TestParseSSHAliases()

### Community 116 - "FuzzSanitize"
Cohesion: 0.18
Nodes (11): Commands you will need, Current state, Done criteria, Git workflow, Maintenance notes, Plan 001: Prevent LAN name merging from panicking on a nil discovery map, Scope, Status (+3 more)

### Community 117 - "TestInit"
Cohesion: 0.18
Nodes (11): Commands you will need, Current state, Done criteria, Git workflow, Maintenance notes, Plan 002: Keep malformed proxy values out of diagnostic output, Scope, Status (+3 more)

### Community 118 - "T"
Cohesion: 0.18
Nodes (11): Commands you will need, Current state, Done criteria, Git workflow, Maintenance notes, Plan 003: Classify a failed configured proxy as degraded, Scope, Status (+3 more)

### Community 120 - "T"
Cohesion: 0.18
Nodes (11): Commands you will need, Current state, Done criteria, Git workflow, Maintenance notes, Plan 005: Validate and release with the same GoReleaser version, Scope, Status (+3 more)
...
### Community 124 - "IP"
Cohesion: 0.40
Nodes (5): Step 1: Pin CI configuration validation, Step 2: Pin the attestation smoke build, Step 3: Document the local prerequisite, Step 4: Validate and run the repository gate, Steps

### Community 125 - "Msg"
Cohesion: 0.40
Nodes (5): Dependency notes, Execution order and status, Findings considered and rejected, Implementation Plans, Vetted findings not selected for plans

### Community 126 - "Time"
Cohesion: 0.50
Nodes (4): Step 1: Centralize the merge into one allocating helper, Step 2: Lock down nil input and alias precedence, Step 3: Format and run the repository gate, Steps

### Community 127 - "jobState"
Cohesion: 0.50
Nodes (4): Step 1: Replace the parser error with stable generic detail, Step 2: Add a regression test proving parser text cannot escape, Step 3: Format and run the repository gate, Steps

### Community 128 - "IP"
Cohesion: 0.50
Nodes (4): Step 1: Add generic and targeted verdict regressions, Step 2: Return the classification already described by the summaries, Step 3: Format and run the repository gate, Steps

### Community 129 - "checks_extra_test.go"
Cohesion: 0.07
Nodes (44): Builder, fakeConn, iwreq, scriptConn, Addr, Conn, Context, Reader (+36 more)

### Community 135 - "jobState"
Cohesion: 0.27
Nodes (3): Cmd, model, jobState

### Community 136 - "model.go"
Cohesion: 0.21
Nodes (11): IP, loadHistory(), mergeLANNames(), NewWithSource(), saveHistory(), lanNameMsg, lanNamesMsg, pendingAction (+3 more)

## Knowledge Gaps
- **291 isolated node(s):** `github.com/heymaikol/network-doctor`, `advertisedName`, `iwreq`, `jobState`, `ToolOutputMsg` (+286 more)
...
- `Diagnose()` (7× useful, score=5.358153309)
- `README.md` (6× useful, score=4.13884217)
- `.handleViewKey()` (5× useful, score=3.601298927)
- `.outputView()` (5× useful, score=3.456281791)
- `.Update()` (4× useful, score=2.78398479) _(code changed — re-verify)_
- `JSON output` (3× useful, score=2.396199306)
- `.viewerFooter()` (3× useful, score=2.281389053)
- `report` (3× useful, score=2.123826899)
- `Install` (3× useful, score=1.722384045)
- `.networkHosts()` (2× useful, score=1.81944443)
...
- **Why does `newModel()` connect `Model Extra Tests` to `UI Model State`, `parseSSHAliases`, `model.go`, `IP`, `toolsFor`?**
  _High betweenness centrality (0.078) - this node is a cross-community bridge._
- **Why does `Target` connect `UI Model State` to `Model Extra Tests`, `Probe Configuration Build`, `parseSSHAliases`, `model.go`, `IP`, `model`, `toolsFor`, `Target`?**
  _High betweenness centrality (0.076) - this node is a cross-community bridge._
- **Why does `model` connect `model` to `UI Model State`, `Probe Configuration Build`, `model.go`, `Clean`, `toolsFor`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Are the 48 inferred relationships involving `newModel()` (e.g. with `TestInit()` and `TestConcurrentToolsCanSwitch()`) actually correct?**
  _`newModel()` has 48 INFERRED edges - model-reasoned connections that need verification._
- **Are the 28 inferred relationships involving `asModel()` (e.g. with `TestConcurrentToolsCanSwitch()` and `TestDeferredQuit()`) actually correct?**
  _`asModel()` has 28 INFERRED edges - model-reasoned connections that need verification._
- **Are the 43 inferred relationships involving `mustTarget()` (e.g. with `TestConcurrentToolsCanSwitch()` and `TestDeferredQuit()`) actually correct?**
  _`mustTarget()` has 43 INFERRED edges - model-reasoned connections that need verification._
- **Are the 12 inferred relationships involving `keyMsg()` (e.g. with `TestConcurrentToolsCanSwitch()` and `TestDeferredQuit()`) actually correct?**
  _`keyMsg()` has 12 INFERRED edges - model-reasoned connections that need verification._