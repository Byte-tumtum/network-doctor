# Graph Report - network-doctor  (2026-07-20)

## Corpus Check
- 83 files · ~78,539 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 688 nodes · 1289 edges · 100 communities (60 shown, 40 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 205 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ee28af6d`
...
Cohesion: 0.11
Nodes (63): containsEnv(), T, TestAppendJobLine(), TestClassifyJob(), TestDeferredQuit(), TestDeferredRestart(), TestDeferredRestartDefersTargetSwap(), TestDeferredTool() (+55 more)

### Community 1 - "UI Model State"
Cohesion: 0.08
Nodes (19): CancelFunc, Cmd, Context, Duration, IP, KeyMsg, Msg, Time (+11 more)
...
Cohesion: 0.19
Nodes (26): cacheAvailability(), curlTool(), Duration, lanDiscoveryTool(), nmapTool(), psArgs(), quoterFor(), shellArgs() (+18 more)
...
Cohesion: 0.11
Nodes (25): Proto, silentConn, Target, T, Time, TestBannerProbeReadTimeout(), TestBannerProbeReadTimeoutHonorsContext(), TestDialIPsCancelledStopsEarly() (+17 more)
...
## Knowledge Gaps
- **167 isolated node(s):** `github.com/heymaikol/network-doctor`, `iwreq`, `ToolOutputMsg`, `scheduleMsg`, `Arch Linux (AUR)` (+162 more)
...
- `Diagnose()` (5× useful, score=4.661181751)
- `.outputView()` (5× useful, score=4.479647402)
- `README.md` (5× useful, score=4.152775327)
- `Probe` (4× useful, score=3.858241817)
- `.Update()` (4× useful, score=3.608290928)
- `.handleViewKey()` (4× useful, score=3.546560073)
- `DowngradeEgress()` (3× useful, score=2.888219072)
- `report` (3× useful, score=2.752667816)
- `Install` (3× useful, score=2.232362313)
- `.View()` (2× useful, score=1.917044184)
...
- **Why does `model` connect `UI Model State` to `Probe Configuration Build`, `UI Application Toolbox`, `Job Execution Lifecycle`, `Probe Construction Tests`?**
  _High betweenness centrality (0.097) - this node is a cross-community bridge._
- **Why does `New()` connect `Probe Construction Tests` to `Model Extra Tests`, `UI Model State`, `Probe Configuration Build`, `ExitCode`, `Network Connection Test Doubles`, `UI Application Toolbox`, `model`, `CancelFunc`?**
  _High betweenness centrality (0.091) - this node is a cross-community bridge._
- **Why does `newModel()` connect `Model Extra Tests` to `ExitCode`, `CancelFunc`, `Probe Construction Tests`?**
...
- **Are the 32 inferred relationships involving `mustTarget()` (e.g. with `TestDeferredQuit()` and `TestDeferredRestart()`) actually correct?**
  _`mustTarget()` has 32 INFERRED edges - model-reasoned connections that need verification._
