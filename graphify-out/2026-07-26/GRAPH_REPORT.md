# Graph Report - network-doctor  (2026-07-26)

## Corpus Check
- 100 files · ~145,331 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 832 nodes · 1437 edges · 121 communities (67 shown, 54 thin omitted)
- Extraction: 85% EXTRACTED · 15% INFERRED · 0% AMBIGUOUS · INFERRED: 215 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `de8f2a6d`
...
Cohesion: 0.10
Nodes (77): T, TestAppendJobLine(), TestClassifyJob(), TestConcurrentToolsCanSwitch(), TestDeferredQuit(), TestDeferredRestart(), TestDeferredRestartDefersTargetSwap(), TestEscClearsCommittedFilterBeforeClosing() (+69 more)

### Community 1 - "UI Model State"
Cohesion: 0.07
Nodes (29): CancelFunc, Context, Duration, Cmd, Target, Tool, model, parseRunArgs() (+21 more)

### Community 2 - "Probe Configuration Build"
Cohesion: 0.10
Nodes (36): CertPool, Config, Attempt, netops, Probe, ProbeID, ProbeResult, Status (+28 more)
...
Cohesion: 0.06
Nodes (49): fakeConn, scriptConn, silentConn, Addr, Conn, Context, Reader, T (+41 more)
...
Cohesion: 0.12
Nodes (24): FlagSet, ExitCode(), Model, T, TestToolboxExitZero(), TestToolsFor(), init(), main() (+16 more)
...
Cohesion: 0.13
Nodes (11): discoveredIPs(), ProbeID, ProbeResult, model, helpKeys(), joinChips(), probeGlyph(), progressBar() (+3 more)
...
### Community 87 - "Target"
Cohesion: 0.11
Nodes (25): Proto, Target, T, mustTarget(), TestBuildProbesNamesProtocolApplicationRow(), TestBuildProbesShape(), Diagnose(), T (+17 more)
...
### Community 105 - ".runProbe"
Cohesion: 0.31
Nodes (7): depsState(), Cmd, Probe, ProbeID, ProbeResult, model, snapshot()

### Community 114 - "model"
Cohesion: 0.33
Nodes (4): appendJobLine(), filterLines(), model, matchesFilter()

### Community 115 - "TestFixHintsPerGOOS"
Cohesion: 0.38
Nodes (5): dnsFix(), ifaceFix(), T, TestFixHintsPerGOOS(), TestSSIDSmoke()

## Knowledge Gaps
- **207 isolated node(s):** `scheduleMsg`, `lanNamesMsg`, `github.com/heymaikol/network-doctor`, `iwreq`, `ToolOutputMsg` (+202 more)
...
- `Diagnose()` (6× useful, score=4.964780519)
- `.handleViewKey()` (5× useful, score=4.038445207) _(code changed — re-verify)_
- `.outputView()` (5× useful, score=3.875825061)
- `README.md` (5× useful, score=3.593012851)
- `.Update()` (4× useful, score=3.121920801) _(code changed — re-verify)_
- `.viewerFooter()` (3× useful, score=2.558317117)
- `DowngradeEgress()` (3× useful, score=2.498909145)
- `report` (3× useful, score=2.381629166)
- `Install` (3× useful, score=1.93145688)
- `job` (2× useful, score=1.777251607)
...
- **Why does `New()` connect `Network Connection Test Doubles` to `Model Extra Tests`, `UI Model State`, `ExitCode`, `UI Application Toolbox`, `Probe Construction Tests`, `Target`?**
  _High betweenness centrality (0.099) - this node is a cross-community bridge._
- **Why does `newModel()` connect `Model Extra Tests` to `ExitCode`, `Network Connection Test Doubles`, `UI Application Toolbox`, `ResolveNames`, `Probe Construction Tests`, `Target`?**
  _High betweenness centrality (0.076) - this node is a cross-community bridge._
- **Why does `Target` connect `Target` to `Model Extra Tests`, `Probe Configuration Build`, `UI Application Toolbox`, `Probe Construction Tests`?**
...
- **Are the 6 inferred relationships involving `keyMsg()` (e.g. with `TestConcurrentToolsCanSwitch()` and `TestDeferredQuit()`) actually correct?**
  _`keyMsg()` has 6 INFERRED edges - model-reasoned connections that need verification._